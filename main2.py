...
from app_rag import call_rag  # Use the original call_rag function from app_rag.py
...
def main():
    ...
    try:
        ...
        response = call_rag(prompt, llm_name="mistral-large-2407")  # Replace with your actual model name
        print("LLM Response:")
        print(response)
